...
const PAGES = [
  ...
  { path: '/ganache', key: 'ganache', locale: 'pt-BR' },
  { path: '/gelificantes', key: 'gelling', locale: 'pt-BR' },
  ...
  { path: '/en/ganache', key: 'ganache', locale: 'en' },
  { path: '/en/gelling', key: 'gelling', locale: 'en' },
];
